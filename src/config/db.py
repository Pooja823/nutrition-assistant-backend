...
# ✅ Use SQLite database instead of AWS
...
class ConsumedFood(Base):
    ...
    consumed_on = Column('consumed_on', DateTime, default=datetime.datetime.utcnow)
...
class User(Base):
    ...
    is_login_process_complete = Column("is_login_process_complete", Boolean, default=False)
